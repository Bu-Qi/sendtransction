...
qki = "https://rpc.chelizi.org.cn/"
web3 = Web3(Web3.HTTPProvider(qki))

print(web3.isConnected())

main_address= ""
contract_address = 'CONTRACT_ADDRESS' #be sure to use a qki Address in uppercase format like this 0x9F0818B... 
...
token_tx = contract.functions.transfer(main_address, amount).buildTransaction({
    'chainId':20181205, 'gas': 100000,'gasPrice': web3.toWei('300','gwei'), 'nonce':nonce
})
